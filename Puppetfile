...
mod 'saz-ssh', '12.0.1' # newer version than in puppet-control
...
mod 'veeam_restore_client',
  ...
  # :ref => '1.5.2'
  :git => 'https://gitlab.services.bris.ac.uk/pp-computing/veeam_restore_client.git',
